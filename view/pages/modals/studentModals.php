                ...
                <form id="editStudentForm">
                    <div class="row">
                        ...
                        <div class="col-md-2 form-group mt-3">
                            ...
                            <input type="text" class="form-control" id="editNumeroInterior" name="numeroInterior" placeholder="Ingresa el número interior" required>
                        </div>

                        <!-- Número Exterior (opcional) -->
                        <div class="col-md-2 form-group mt-3">
                            <label for="editNumeroExterior" class="form-label">Número Exterior</label>
                            <input type="text" class="form-control" id="editNumeroExterior" name="numeroExterior" placeholder="Ingresa el número exterior">
                        </div>
